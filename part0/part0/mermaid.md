sequenceDiagram
    ...
    activate server
    Note left of server: Server receives the new note data<br/>and saves it
    ...
    Note right of browser: The browser renders the notes, including the newly added one